        ...
        <div class="row g-0">
            <div class="col-lg-5 auth-hero">
                <div class="fade-up">
                    ...
                    <h1 class="mb-3">Mulai Perjalanan Literasi</h1>
                    <p class="mb-4">
                        Buat akun untuk mulai meminjam, melacak buku favorit, dan menikmati layanan perpustakaan yang rapi.
                    </p>
                    <div class="d-flex gap-3 flex-wrap">
                        <span class="badge bg-light text-dark rounded-pill px-3 py-2">Aman</span>
                        <span class="badge bg-light text-dark rounded-pill px-3 py-2">Terarah</span>
                        <span class="badge bg-light text-dark rounded-pill px-3 py-2">Siap Pakai</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-7 form-side">
                ...
                <form action="{{ route('register.post') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="password_confirmation" class="form-control" placeholder="Ulang password" required>
                    </div>
